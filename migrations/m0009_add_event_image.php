<?php
    ...
    class m0009_add_event_image {
        public function up() {
            ...
            $sql_command = "ALTER TABLE comments ADD content TEXT NULL AFTER answer_id;
        ...
        public function down() {
            $db = Application::$app->db;
            $sql_command = "ALTER TABLE comments DROP content;
            DELETE FROM `images` WHERE `images`.`image_id` = 36;
