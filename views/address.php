...
<div class="box-confirm box-form" id="box-form">
      ...
      <form action="http://localhost:8000/update-info" class="form-group">
            ...
            <button type="submit" class='btn order-btn'>Update</button>
            <button type="button" class='btn order-btn' onclick="closeUpdateBox()">Cancel</button>
      </form>
</div>
