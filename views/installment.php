    ...
    <h3>CONDITIONS AND ORIGINAL DOCUMENTS REQUIRED</h3>
        <ul>
            <li>Age from 20 to 60 (according to date of birth on identity card).</li>
            <li>Valid identity card (15 years from the date of issue).</li>
            <li>Household registration (the buyer must be in the household registration book).
