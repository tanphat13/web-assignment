...
<div class="product">
    ...
    <div class="rightInfo" >
        <div class="more-info">
            <ul>
                <li>
                    <svg width="3em" height="1em" viewBox="0 0 16 16" class="bi bi-box-seam" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <svg width="3em" height="1em" viewBox="0 0 16 16" class="bi bi-shield-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <svg width="3em" height="1em" viewBox="0 0 16 16" class="bi bi-truck" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <?php
            foreach ($model['branches'] as $branch) {
                echo "<p>$branch->branch_address</p>";
            }
        ?>
    </div>
</div>